...
# CONFIGURATION
INPUT_FILE = RAW_DATA_DIR / "dam_dmnd/dataset.csv"
OUTPUT_FILE_5MIN = CLEANED_DATA_DIR / "demand_cleaned_5min.csv"
OUTPUT_FILE_HOURLY = CLEANED_DATA_DIR / "demand_cleaned_hourly.csv"
