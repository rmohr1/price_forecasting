...
# CONFIGURATION
INPUT_FILE = "../../data/raw/caiso_rtpd_prc/dataset.csv"
OUTPUT_FILE_5MIN = "../../data/processed/rtpd_prc_cleaned_5min.csv"
OUTPUT_FILE_HOURLY = "../../data/processed/rtpd_prc_cleaned_hourly.csv"
